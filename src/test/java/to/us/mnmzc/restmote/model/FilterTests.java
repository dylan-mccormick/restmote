...
public class FilterTests {
    ...
    void testSimpleFilterEvaluation() {
        Filter filter = getFilterWithConditions(List.of(
    ...
    void testEQOperatorTrue() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("name", FilterOperator.EQ, "John")
        ));
    ...
    void testNEQOperatorTrue() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("status", FilterOperator.NEQ, "inactive")
        ));
    ...
    void testNEQOperatorFalse() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("status", FilterOperator.NEQ, "active")
        ));
        Map<String, Object> attributes = Map.of("status", "active");
        Assertions.assertFalse(FilterEvaluator.evaluate(filter, attributes));
    }
    ...
    void testGTOperatorFalse() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("age", FilterOperator.GT, 25)
        ));
    ...
    void testLTOperatorTrue() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("age", FilterOperator.LT, 30)
        ));
    ...
    void testLTOperatorFalse() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("age", FilterOperator.LT, 20)
        ));
    ...
    void testGTEOperatorTrue() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("score", FilterOperator.GTE, 100)
        ));
    ...
    void testLTEOperatorTrue() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("score", FilterOperator.LTE, 100)
        ));
        Map<String, Object> attributes = Map.of("score", 100);
        Assertions.assertTrue(FilterEvaluator.evaluate(filter, attributes));
    }
    ...
    void testCONTAINSOperatorTrue() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("description", FilterOperator.CONTAINS, "Java")
        ));
    ...
    void testCONTAINSOperatorFalse() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("description", FilterOperator.CONTAINS, "Python")
        ));
        Map<String, Object> attributes = Map.of("description", "This is a Java project");
        Assertions.assertFalse(FilterEvaluator.evaluate(filter, attributes));
    }
    ...
    void testINOperatorTrue() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("status", FilterOperator.IN, List.of("active", "pending", "completed"))
        ));
        Map<String, Object> attributes = Map.of("status", "active");
        Assertions.assertTrue(FilterEvaluator.evaluate(filter, attributes));
    }
    ...
    void testNullFilterValue() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("name", FilterOperator.EQ, null)
        ));
        Map<String, Object> attributes = new HashMap<>();
        attributes.put("name", null);
        Assertions.assertTrue(FilterEvaluator.evaluate(filter, attributes));
    ...
    void testMissingAttributeKey() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("missing", FilterOperator.EQ, "value")
        ));
    ...
    void testEmptyStringValue() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("text", FilterOperator.EQ, "")
        ));
    ...
    void testCONTAINSEmptyString() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("text", FilterOperator.CONTAINS, "")
        ));
    ...
    void testNumericStringComparison() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("id", FilterOperator.EQ, "123")
        ));
    ...
    void testGTNegativeNumbers() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("temp", FilterOperator.GT, -10)
        ));
    ...
    void testLTNegativeNumbers() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("temp", FilterOperator.LT, -5)
        ));
    ...
    void testFloatingPointComparison() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("price", FilterOperator.GT, 19.99)
        ));
    ...
    void testINOperatorEmptyList() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("status", FilterOperator.IN, List.of())
        ));
        Map<String, Object> attributes = Map.of("status", "active");
        Assertions.assertFalse(FilterEvaluator.evaluate(filter, attributes));
    }
    ...
    void testZeroValueComparison() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("count", FilterOperator.EQ, 0)
        ));
    ...
    void testNEQWithNull() {
        Filter filter = getFilterWithConditions(List.of(
                new FilterCondition("value", FilterOperator.NEQ, null)
        ));
