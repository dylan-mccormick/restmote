...
/**
 * A global exception handler for handling exceptions thrown by the controllers and returning
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ApiMessage> handleMissingParams(
  ...
  public ResponseEntity<ApiMessage> handleTypeMismatch(MethodArgumentTypeMismatchException ex) {
    ...
    String message =
        String.format("Parameter '%s' is of the wrong type. Expected type: %s", name, type);
    return ResponseEntity.badRequest().body(new ApiMessage(message));
  }

  @ExceptionHandler(HttpMessageNotReadableException.class)
  public ResponseEntity<ApiMessage> handleHttpMessageNotReadable(
