...
/**
 * Contains the types of payloads that can be sent in a message.
 * Has no effect on the message itself, but can be used by the receiver to determine how to handle the payload.
 */
